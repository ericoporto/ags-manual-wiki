...
game.screenshot_height | The height of screenshot images when saved into save games. The largest you can have is the full screen size (game resolution), which gives the highest quality but the largest size save game files. The default is 160x100.
...
game.top_bar_XXXX | Customizations for [DisplayTopBar](DisplayFunctions#displaytopbar), see link for details
