...
All this means, use 8-bit color only when you know what you are doing
or when you intentionally want to punish you with lots of nerdy fumbling 
around on settings for colormodes that were not artists decisions but 
actual hardware limitations of the time and every artist is glad these 
