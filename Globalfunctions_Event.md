...
The purpose of "validate_restored_save" is to receive a struct `RestoredSaveInfo` which contains a summary about the save, and let game developer decide whether to accept or cancel this save.
