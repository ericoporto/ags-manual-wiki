...
* **Enforce new style strings** - this is on by default, turning this off reactivates old-style string functions and also the deprecated `string` type (the contemporary type is `[String](String)` with capital S) which was used differently and had a 200 character limit.
